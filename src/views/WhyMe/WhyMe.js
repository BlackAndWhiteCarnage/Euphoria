...
import { Wrapper, SectionContentWrapper, SectionHeader, SectionContent } from './WhyMe.styles';
  ...
  return (
    <Wrapper ref={element}>
      <SectionContentWrapper>
        <SectionHeader className={darkMode && 'darkMode'}>DLACZEGO U MNIE?</SectionHeader>
